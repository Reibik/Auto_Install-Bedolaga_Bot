...
> **Версия 19.0** — масштабный рефакторинг: скрипт уменьшен на 21% (2313 -> 1819 строк), 13 хелпер-функций для дедупликации кода, все фичи v18.0 сохранены. См. [CHANGELOG.md](CHANGELOG.md) для полного списка изменений.
